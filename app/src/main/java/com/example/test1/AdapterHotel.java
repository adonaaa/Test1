...
public class AdapterHotel extends RecyclerView.Adapter<AdapterHotel.ViewHolder> {
    ...
    @Override
    public AdapterHotel.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.row, parent, false);
        return new AdapterHotel.ViewHolder(view);
    }

    // binds the data to the TextView in each row
    @Override
    public void onBindViewHolder(AdapterHotel.ViewHolder holder, int position) {
        hotels hotel = mData.get(position);
...
//            ivPhoto = itemView.findViewById(R.id.ivPhotoHotelRow);
    ...
    void setClickListener(AdapterHotel.ItemClickListener itemClickListener) {
